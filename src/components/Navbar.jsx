  ...
  return (
    <nav className="bg-white shadow dark:bg-gray-800 z-50">
      <div className="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-300">
        <div className="border-b-2 border-transparent hover:text-gray-800 transition-colors duration-200 transform dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">
          <svg
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "text-gray-800 transition-colors duration-200 transform dark:text-gray-200 border-b-2 mx-1.5 sm:mx-6 cursor-pointer border-blue-500"
              : "text-gray-800 transition-colors duration-200 transform dark:text-gray-200 border-b-2 mx-1.5 sm:mx-6 cursor-pointer"
          }
        >
          List Pokemon
        </NavLink>
